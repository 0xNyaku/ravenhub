...
queue_on_teleport([[
    loadstring(game:HttpGet("https://raw.githubusercontent.com/0xNyaku/ravenhub/main/ravenhubfree.lua"))()
]])
...
if (executor == "Synapse X" or executor == "Krnl") and secure_call then
    ...
    SpecterHub:AddNoti("Warning", "Your Exploit Is Not Supported, Our Script's might not working perfectly (Supported Exploit: KRNL,Synapse X)", 1)
end
