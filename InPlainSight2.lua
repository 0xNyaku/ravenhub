...
local Window = Library.CreateLib("In Plain Sight 2 - By Nyaku - Lofeu is always here", "BloodTheme")

local Tab = Window:NewTab("Main")
local Section = Tab:NewSection("ESP & Shits")
Section:NewButton("SpeedHack", ".", function()
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 120
end)

Section:NewButton("Noclip", ".", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/vyM1anJc", true))()
end)

Section:NewButton("Invisible", ".", function()
	loadstring(game:HttpGet('https://pastebin.com/raw/Z7wT5jvN'))()
end)	

Section:NewButton("Camera", ".", function()
    if game.PlaceVersion ~= 5572 then
    local response = messagebox("Welcome", 52)
